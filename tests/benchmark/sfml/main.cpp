...
int main() {
    ...
    runner.add(std::make_unique<BenchmarkSfml>( "Benchmark Sfml No Effects", window, backend, std::move(pipelineNoEffects), 0));
    ...
    glGetIntegerv(GL_GPU_MEM_INFO_CURRENT_AVAILABLE_MEM_NVX, &vramAfter);
    vramUsed = vramBefore - vramAfter;
    runner.add(std::make_unique<BenchmarkSfml>( "Benchmark Sfml ContrastEffect", window, backend, std::move(pipelineContrast), vramUsed));
    ...
    glGetIntegerv(GL_GPU_MEM_INFO_CURRENT_AVAILABLE_MEM_NVX, &vramAfter);
    vramUsed = vramBefore - vramAfter;
    runner.add(std::make_unique<BenchmarkSfml>( "Benchmark Sfml GrayscaleEffect", window, backend, std::move(pipelineGrayscale), vramUsed));
    ...
    glGetIntegerv(GL_GPU_MEM_INFO_CURRENT_AVAILABLE_MEM_NVX, &vramAfter);
    vramUsed = vramBefore - vramAfter;
    runner.add(std::make_unique<BenchmarkSfml>( "Benchmark Sfml GaussianBlurEffect", window, backend, std::move(pipelineGaussianBlur), vramUsed));
    ...
    glGetIntegerv(GL_GPU_MEM_INFO_CURRENT_AVAILABLE_MEM_NVX, &vramAfter);
    vramUsed = vramBefore - vramAfter;
    runner.add(std::make_unique<BenchmarkSfml>( "Benchmark Sfml TwoEffects", window, backend, std::move(pipelineTwoEffects), vramUsed));
    ...
    glGetIntegerv(GL_GPU_MEM_INFO_CURRENT_AVAILABLE_MEM_NVX, &vramAfter);
    vramUsed = vramBefore - vramAfter;
    runner.add(std::make_unique<BenchmarkSfml>( "Benchmark Sfml ThreeEffects", window, backend, std::move(pipelineThreeEffects), vramUsed));
